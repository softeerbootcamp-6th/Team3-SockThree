...
@Tag(name = "Assignment Submission", description = "학생 과제 제출 관리 API")
@RestController
...
public class AssignmentSubmissionController {
    ...
    @Operation(summary = "과제 제출 삭제 (수강생)", description = "학생이 제출한 과제를 삭제합니다.")
    ...
    @Operation(summary = "[Page] 내 과제 제출 목록 조회 (수강생)", description = "현재 학생의 과제 제출 목록을 조회합니다.")
    ...
    @Operation(summary = "[Page] 특정 과제 제출 조회 (수강생)", description = "특정 과제에 대한 현재 학생의 제출을 조회합니다.")
    ...
    @Operation(summary = "[Page] 특정 과제의 모든 제출 조회 (강사)", description = "특정 과제의 모든 제출을 조회합니다. (강사용)")
    ...
    @Operation(summary = "과제 제출 여부 확인 (수강생)", description = "특정 과제에 대한 제출 여부를 확인합니다.")
    ...
    @Operation(summary = "내 과제 제출 수 조회 (수강생)", description = "현재 학생의 총 과제 제출 수를 조회합니다.")
