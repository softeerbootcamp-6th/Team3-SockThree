...
public record WidgetSettingResponse(
        ...
        @Schema(required = true, description = "행 위치", example = "1") Integer rowPosition,
        @Schema(required = true, description = "열 위치", example = "1") Integer colPosition,
        @Schema(required = true, description = "위젯 크기", example = "SMALL") WidgetSize widgetSize,
        @Schema(required = true, description = "표시 여부", example = "true") Boolean visible,
