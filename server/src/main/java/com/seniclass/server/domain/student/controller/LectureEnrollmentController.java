...
@Tag(name = "Lecture Enrollment", description = "학생 강의 수강 관리 API")
@RestController
...
public class LectureEnrollmentController {
    ...
    @Operation(summary = "내 수강 강의 목록 조회 (수강생)", description = "현재 로그인한 학생의 수강 중인 강의 목록을 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "강의 수강 등록 (수강생)", description = "새로운 강의에 수강 등록합니다.")
    @PostMapping
    ...
    @Operation(summary = "수강 취소 (수강생)", description = "수강을 취소합니다.")
    ...
    @Operation(summary = "강의로 수강 취소 (수강생)", description = "강의 ID로 수강을 취소합니다.")
    ...
    @Operation(summary = "강의 수강 여부 확인 (수강생)", description = "특정 강의에 수강 등록되어 있는지 확인합니다.")
    ...
    @Operation(summary = "내 수강 강의 수 조회 (수강생)", description = "현재 수강 중인 강의 수를 조회합니다.")
    @GetMapping("/count")
    @RequireAuth(roles = {UserRole.STUDENT})
    ...
    @Operation(summary = "특정 강의의 수강생 목록 조회 (강사)", description = "특정 강의의 수강생 목록을 조회합니다.")
