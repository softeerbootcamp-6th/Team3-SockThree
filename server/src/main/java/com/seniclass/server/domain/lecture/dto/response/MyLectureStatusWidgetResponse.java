...
public record MyLectureStatusWidgetResponse(
        ...
        @Schema(required = true, description = "총 동영상 개수", example = "10") Integer lectureVideoCount,
        @Schema(required = true, description = "가장 가까운 과제 마감일", example = "2025-08-20T23:59:59")
                LocalDateTime assignmentDueDateTime,
        @Schema(required = true, description = "과제 이름", example = "1주차 과제") String assignmentName,
        @Schema(required = true, description = "과제 제출 여부", example = "true") Boolean isAssignmentSubmitted) {
