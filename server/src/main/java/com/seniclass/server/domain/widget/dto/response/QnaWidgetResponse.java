...
public record QnaWidgetResponse(
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "최근 질문 목록")
                List<QnaItem> recentQuestions,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "내 질문 목록")
                List<QnaItem> myQuestions) {
    ...
    public record QnaItem(
            ...
            @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "질문")
                    String question,
            ...
            @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "내 질문 여부")
