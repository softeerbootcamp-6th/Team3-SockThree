...
@Tag(name = "Interest Category", description = "학생 관심 카테고리 관리 API")
@RestController
...
public class InterestingCategoryController {
    ...
    @Operation(summary = "내 관심 카테고리 목록 조회 (수강생)", description = "현재 로그인한 학생의 관심 카테고리 목록을 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "관심 카테고리 추가 (수강생)", description = "새로운 관심 카테고리를 추가합니다.")
    @PostMapping
    ...
    @Operation(summary = "관심 카테고리 삭제 (수강생)", description = "관심 카테고리를 삭제합니다.")
    ...
    @Operation(summary = "서브 카테고리로 관심 카테고리 삭제 (수강생)", description = "서브 카테고리 ID로 관심 카테고리를 삭제합니다.")
