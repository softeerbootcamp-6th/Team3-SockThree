...
public enum AssignmentSubmissionErrorCode implements BaseErrorCode {
    ...
    ASSIGNMENT_FILE_NOT_FOUND(HttpStatus.NOT_FOUND, "과제 파일을 찾을 수 없습니다."),

    // 409 Conflict
    ASSIGNMENT_SUBMISSION_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 제출한 과제입니다."),

    // 400 Bad Request
    ASSIGNMENT_DEADLINE_PASSED(HttpStatus.BAD_REQUEST, "과제 제출 마감일이 지났습니다."),

    // 500 Internal Server Error
    ASSIGNMENT_FILE_UPLOAD_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "파일 업로드에 실패했습니다.");
