...
@Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "리뷰 응답")
public record ReviewResponse(
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "리뷰 ID", example = "1")
                Long id,
        @Schema(
                ...
                String content,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "평점", example = "4.5")
                Double rating,
        ...
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "학생 ID", example = "1")
                Long studentId,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "학생 이름", example = "홍길동")
                String studentName,
        @Schema(
                        requiredMode = Schema.RequiredMode.REQUIRED,
                        description = "생성일시",
