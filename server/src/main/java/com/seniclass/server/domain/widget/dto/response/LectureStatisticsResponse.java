...
@Schema(required = true, description = "강좌 수강생 통계 응답")
public record LectureStatisticsResponse(
    ...
    @Schema(required = true, description = "비디오 수강 통계")
    ...
    @Schema(required = true, description = "과제 제출률 통계")
    public record AssignmentSubmissionStatistics(
        ...
        @Schema(required = true, description = "과제별 제출률")
    ...
    @Schema(required = true, description = "연령대별 수강생 통계")
