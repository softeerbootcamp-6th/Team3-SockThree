...
@Schema(description = "강의 QnA 응답")
public record LectureQnaResponse(
        @Schema(description = "QnA ID", example = "1") Long id,
        ...
        @Schema(description = "질문 내용", example = "자바의 다형성에 대해 자세히 설명해주세요.") String question,
        @Schema(description = "답변 내용", example = "다형성은 하나의 객체가...") String answer,
        @Schema(description = "답변 여부", example = "true") boolean isAnswered,
        @Schema(description = "질문 생성일시", example = "2023-12-01T10:00:00")
                LocalDateTime questionCreatedAt,
        @Schema(description = "마지막 수정일시", example = "2023-12-01T11:00:00")
