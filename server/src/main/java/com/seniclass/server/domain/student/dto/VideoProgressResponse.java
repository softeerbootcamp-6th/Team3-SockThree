...
@Schema(description = "비디오 진행 상황 응답")
public record VideoProgressResponse(
        @Schema(description = "진행 상황 ID", example = "1") Long id,
        @Schema(description = "학생 ID", example = "1") Long studentId,
        @Schema(description = "학생 이름", example = "김학생") String studentName,
        @Schema(description = "비디오 ID", example = "1") Long videoId,
        @Schema(description = "비디오 이름", example = "1강 - Java 소개") String videoName,
        @Schema(description = "강의 ID", example = "1") Long lectureId,
        @Schema(description = "강의 이름", example = "Java 프로그래밍 기초") String lectureName,
        @Schema(description = "챕터 이름", example = "1장 - Java 기초") String chapterName,
        @Schema(description = "재생 시간 (초)", example = "120") Long playedTime,
        @Schema(description = "마지막 시청일시", example = "2023-12-01T10:00:00")
