...
public record VideoProgressResponse(
        ...
        @Schema(required = true, description = "비디오 ID", example = "1") Long videoId,
        @Schema(required = true, description = "비디오 이름", example = "1강 - Java 소개") String videoName,
        ...
        @Schema(required = true, description = "챕터 이름", example = "1장 - Java 기초") String chapterName,
        @Schema(required = true, description = "재생 시간 (초)", example = "120") Long playedTime,
        @Schema(required = true, description = "마지막 시청일시", example = "2023-12-01T10:00:00")
