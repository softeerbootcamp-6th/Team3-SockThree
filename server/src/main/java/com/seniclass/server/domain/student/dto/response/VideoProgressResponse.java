...
@Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "비디오 진행 상황 응답")
public record VideoProgressResponse(
        ...
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "학생 이름", example = "김학생")
                String studentName,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "비디오 ID", example = "1")
                Long videoId,
        @Schema(
                        requiredMode = Schema.RequiredMode.REQUIRED,
                        description = "비디오 이름",
