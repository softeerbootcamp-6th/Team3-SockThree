...
@Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "강의 북마크 응답")
public record LectureBookmarkResponse(
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "북마크 ID", example = "1")
                Long id,
        ...
        @Schema(
                        ...
                        example = "50000")
                Integer fee,
        @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "북마크 추가일시")
