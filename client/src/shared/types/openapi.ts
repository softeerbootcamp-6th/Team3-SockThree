...
export interface paths {
    ...
    "/lectures/{lectureId}/widgets/teacher": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description 특정 강의의 강사 정보 위젯에 필요한 데이터를 조회합니다.
         *
         *     포함되는 정보:
         *     1. 강사의 이름, 나이, 성별, 자기소개, 프로필 이미지
         *
         */
        get: operations["getTeacherWidget"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        WidgetSpec: {
             ...
             * @enum {string}
             */
            type: "QNA" | "SUBMISSION" | "TEACHER_INFO" | "REVIEW" | "NEXT_LECTURE" | "STUDENTS_STATUS";
            /**
             * Format: int32
             * @description 행 위치
             * @example 1
